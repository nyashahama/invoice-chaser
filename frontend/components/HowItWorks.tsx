...
export default function HowItWorks() {
  ...
  return (
    <section className="py-[120px] px-12 max-w-[1200px] mx-auto md:py-20 md:px-6" id="how">
      ...
      <div ref={ref} className="grid grid-cols-3 gap-px bg-border-default border border-border-default md:grid-cols-1 reveal">
        <div className="bg-black py-12 px-10 relative transition-colors hover:bg-surface duration-300 step">
          ...
          <p className="text-sm text-text-dim leading-relaxed font-mono font-normal">
