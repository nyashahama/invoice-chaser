...
export default function Testimonials() {
  ...
  return (
    <section className="pt-0 pb-[120px] px-12 max-w-[1200px] mx-auto md:pb-20 md:px-6">
      ...
      <div ref={ref} className="grid grid-cols-3 gap-6 mt-[60px] md:grid-cols-1 reveal">
        <div className="testimonial border border-border-default py-8 px-8 rounded-[2px] relative transition-colors hover:border-border-light">
          ...
          <div className="font-serif italic text-[17px] leading-relaxed text-text mb-6">
