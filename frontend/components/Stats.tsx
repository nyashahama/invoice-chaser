  ...
  return (
    <>
      ...
      <div className="relative overflow-hidden bg-surface px-6 grid grid-cols-1 md:grid-cols-3 md:px-12">
        ...
        <div ref={statRev.ref} className="py-10 border-b border-border-default opacity-0 animate-fade-up md:border-b-0 md:border-r md:px-12">
        ...
        <div ref={statPaid.ref} className="py-10 border-b border-border-default opacity-0 animate-fade-up md:border-b-0 md:border-r md:px-12">
